    ...
    public sealed class TargetAnimationSystem : ISystem
    {
        ...
        public void OnUpdate(float deltaTime)
        {
            foreach (var unitEntity in _unitFilter)
            {
                ...
                {
                    ref var unitComponent = ref _unitStash.Get(targetComponent.TargetEntity);
                    ref var animatorComponent = ref _animatorComponentStash.Get(unitEntity);
                    
                    var currentIndicatorPos = animatorComponent.TargetTransform.position;
                    var actualTargetPos = unitComponent.RootTransform.position;
                    ...
                    animatorComponent.TargetTransform.position = smoothedPosition;
                }
            }
        }
